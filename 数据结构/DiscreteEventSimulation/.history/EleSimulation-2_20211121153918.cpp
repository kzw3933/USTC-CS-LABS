...
//显示当前状态
void ShowStates();
void TableShowStates(State SB,State S,State SN,int d0,int d1,int d2,int d3,int d4,int Up0,int Up1,int Up2,int Up3,int Up4,int Down0,int Down1,int Down2,int Down3,int Down4);
