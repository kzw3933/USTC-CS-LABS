...
void ShowStates(int i){
    ...
    for(i=0;i<5;i++){
       ...
       Passenger * top = elevator[i].passerstack[i].top;
       while(top != (elevator[i].passerstack[i].base)){
           top -- ;
           d[i]++;
       }
    }
