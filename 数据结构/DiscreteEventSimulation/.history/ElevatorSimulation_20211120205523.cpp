...
#include<stdlib.h>
//1.定义必要的数据类型
typedef  enum EventType {EleArivStay,EleBackOne,EleOpen,EleClose,EleOpenOver,EleCloseOver,EleCheck,EleStUp,EleStDown,EleStUpOneFloor,EleStDownOneFloor,
EleBackOneDownOneFloor,EleBackOneUpOneFloor,PassAriv,PassGetUpOver,PassGetDownOver,PassGiveUp} EventType;     //事件类型
//注意
