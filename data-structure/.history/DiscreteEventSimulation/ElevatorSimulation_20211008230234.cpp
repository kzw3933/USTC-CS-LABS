...
#include<stdlib.h>
//定义必要的数据类型
typedef  enum EventType {EleCheck,EleAriv,EleStUp,EleStDown,EleStay,EleBackOne,EleOpen,EleClose,PassAriv,PassGetUp,PassGetDown,PassGiveUp,PassGiveUpPre} EventType;
...
void HandlePassDepart(Event entmp);
void HandlePassGiveUp(Event entmp);
void HandlePassGiveUpPre(Event entmp);    //需要特殊处理
void HandlePassGetDown(Event entmp);
void HandlePassGetDown(Event entmp);
void HandleEleAriv(Event entmp);            
void HandleEleStUp(Event entmp);           //需要特殊处理
void HandleEleBackOne(Event entmp);        //需要特殊处理
void HandleEleStDown(Event entmp);         //需要特殊处理
...
void HandleCurEvent(Event entmp){
        ...
        case PassGiveUpPre:HandlePassGiveUpPre(entmp);break;
