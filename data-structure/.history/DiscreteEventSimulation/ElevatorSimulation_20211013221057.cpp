...
void HandleCurEvent(Event entmp){
        ...
        case EleStDownOneFloor: HandleEleStDownOneFloor(Event entmp);break;
        case EleStUpOneFloor: HandleEleStUpOneFloor(Event entmp);break;
        case EleBackOneDownOneFloor: HandleEleBackOneDownOneFloor(Event entmp);break;
        case EleBackOneUpOneFloor: HandleEleBackOneUpOneFloor(Event entmp);break;
        default: break;
    }  
}
...
void HandleEleOpenOver(Event entmp){   
    ...
    elevator.statenext = DecideNextState(entmp.floor);   //更新电梯下一个状态
...
void HandleEleStUp(Event entmp){  
    ...
    Event entmpNew = {entmp.OccurTime+15+51,EleStUpOneFloor,entmp.floor+1};
    OrderInsert(entmpNew);
    ShowEvent(entmp);
}  
void HandleEleStUpOneFloor(Event entmp){
