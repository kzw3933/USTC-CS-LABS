...
#include<stdlib.h>
//定义必要的数据类型
typedef  enum EventType {EleCheck,EleAriv,EleStUp,EleStDown,EleStay,EleBackOne,EleOpen,EleClose,PassAriv,PassGetUpOver,PassGetDownOver,PassGiveUp} EventType;
