...
#include<stdlib.h>
//定义必要的数据类型
typedef  enum EventType {EleStay,EleCheck,EleArivStay,EleBackOne,EleOpen,EleClose,EleOpenOver,EleCloseOver,EleStUp,EleStDown,PassAriv,PassGetUpOver,PassGetDownOver,PassGiveUp} EventType;
//事件具有不同的优先度,对于同时刻发生的事,要保证 1. 电梯到达停留，乘客到达,先处理电梯到达停留
