...
void HandleEleUpOneFloor(Event entmp); 
void HandleEleDownOneFloor(Event entmp);         
...
void HandleCurEvent(Event entmp){
        ...
        case EleDownOnefloor: HandleEleDownOneFloor(entmp);break;
        case EleUpOneFloor: HandleEleUpOneFloor(entmp);break;
...
void HandleEleOpenOver(Event entmp){
    ...
    if(entmp.type == EleOpenOver){
        ...
        Event entmpNew4 = {TimeNow,EleClose,entmp.floor};
